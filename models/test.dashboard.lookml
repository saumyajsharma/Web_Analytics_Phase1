- dashboard: web_analytics_phase1
  ...
  - title: Sessions Per User
    ...
    explore: sessions
    type: single_value
    fields: [sessions.Sessions_Per_User]
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: Engaged Sessions
    ...
    explore: sessions
    type: single_value
    fields: [sessions.Engaged_Sessions]
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: User Breakdown
    ...
    - category: measure
      ...
      filter_expression: "${sessions.new_user_flag} = yes"
      _kind_hint: measure
      measure: new_users
      type: count_distinct
      _type_hint: number
  ...
  - title: Top Pages by Traffic
    ...
    type: looker_grid
    fields: [dynamicschema.Users, dynamicschema.page__page_name, dynamicschema.Sessions]
    sorts: [dynamicschema.Users desc]
    limit: 5
    column_limit: 50
    show_view_names: false
